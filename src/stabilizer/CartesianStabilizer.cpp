...
, leftFootPostureController(new TwoDOFPostureController(40, 5, 80, 5))
, rightFootPostureController(new TwoDOFPostureController(40, 5, 80, 5))
, pelvisPostureController(new TwoDOFPostureController(40, 5, 80, 5))
, nodes(nodes)
