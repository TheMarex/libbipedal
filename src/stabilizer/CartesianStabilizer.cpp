...
, rightFoot(rightFoot)
, pelvis(pelvis)
, chestPostureController(new TwoDOFPostureController(20, 5, 40, 5))
, leftFootPostureController(new TwoDOFPostureController(10, 20, 10, 20))
, rightFootPostureController(new TwoDOFPostureController(10, 20, 10, 20))
